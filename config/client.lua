        ...
        pdm = {
            ...
            showroomVehicles = {
                [1] = {
                    ...
                    defaultVehicle = 'entity2', -- Default display vehicle
                    chosenVehicle = 'entity2' -- Same as default but is dynamically changed when swapping vehicles
                },
                [2] = {
                ...
                [4] = {
                    ...
                    defaultVehicle = 'infernus2',
                    chosenVehicle = 'infernus2'
                },
                [5] = {
                    coords = vector4(-54.48, -1096.71, 26.3, 293.13),
                    defaultVehicle = 'torero2',
                    chosenVehicle = 'torero2'
                }
            },
        },
